  ...
  const features = [
    {
      ...
      description: "Comprehensive, straight-forward, and easy to configure SPI firewall.",
    },
    {
      name: "Login Failure Daemon",
      description: "Constantly runs and periodically scans logs for brute-force detection.",
    },
    {
      name: "Control Panel Interface",
      description:
        "GUI accessible through cPanel, DirectAdmin and OpenPanel.",
    },
  ]
  ...
  return (
    <div className="px-3">
      ...
      >
        ...
        >
          The firewall <br /> for webhosting
        </h2>
        <canvas
