...
export default function CodeExample() {
  return (
    ...
    >
      ...
      >
        Migrate from CSF <br /> to Sentinel Firewall
      </h2>
      <p className="mt-6 max-w-2xl text-lg text-gray-600 dark:text-gray-400">
        Sentinel is a maintained fork of the ConfigServer Firewall & Security (CSF) tool. Migrating from an existing CSF installation to Sentinel is simple and can be done with just a single command:
      </p>
      <CodeExampleTabs
        tab1={
